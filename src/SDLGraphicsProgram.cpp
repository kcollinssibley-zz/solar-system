...
void SDLGraphicsProgram::loop(){
    ...
    sphere4 = new Sphere();
    Asteroid = new SceneNode(sphere4);
    ...
    while(!quit) {
        ...
        Asteroid->getLocalTransform().loadIdentity();
        Asteroid->getLocalTransform().translate(6.0f, 0.0f, 0.0f);
        Asteroid->getLocalTransform().scale(0.2f, 0.2f, 0.2f);
        Asteroid->getLocalTransform().rotate(glm::radians(-500*rotate), 0.0f, 1.0f, 0.0f);
        ...
        Moon->getLocalTransform().rotate(glm::radians(-20*rotate),0.0f,1.0f,0.0f);
        ...
        Earth->getLocalTransform().rotate(glm::radians(rotate),0.0f,1.0f,0.0f);

        Sun->getLocalTransform().loadIdentity();
        Sun->getLocalTransform().translate(0.0f,0.0f,-3.0f);
        Sun->getLocalTransform().rotate(glm::radians(rotate),0.0f,1.0f,0.0f);
        // =============== Move the planets =============================
